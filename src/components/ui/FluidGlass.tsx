...
export default function FluidGlass({ mode = 'lens', lensProps = {}, barProps = {}, cubeProps = {} }: FluidGlassProps) {
  ...
  // Preload models to avoid stalls on mobile
  useEffect(() => {
...
const ModeWrapper = memo(function ModeWrapper({
  ...
  useFrame((state, delta) => {
    ...
    gl.setClearColor(0x000000, 0); // transparent background to overlay on page
  });
  ...
  return (
    <>
      ...
      >
        <MeshTransmissionMaterial
          // Support both APIs across drei versions
          buffer={buffer.texture as any}
          background={buffer.texture as any}
          ior={ior ?? 1.15}
